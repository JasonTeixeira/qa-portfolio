        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          ...
          >
            <Link
              ...
              className="group block rounded-3xl overflow-hidden border border-[#27272A] bg-[#0F0F12] hover:border-[#06B6D4]/50 transition-all"
            >
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-5">
                    <span className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#06B6D4] bg-[#06B6D4]/10 border border-[#06B6D4]/30 px-2.5 py-1 rounded-full">
                      Featured
                    </span>
                  ...
                  <h2 className="text-3xl sm:text-4xl font-bold text-[#FAFAFA] leading-tight group-hover:text-[#06B6D4] transition-colors">
                    {featuredPost.title}
                  </h2>
                  <p className="mt-5 text-[#A1A1AA] leading-relaxed line-clamp-3">
                    {featuredPost.excerpt}
                  </p>
                  <div className="mt-7 inline-flex items-center gap-1.5 text-sm font-medium text-[#06B6D4] group-hover:gap-2.5 transition-all">
                    Read article
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {post.tags.slice(0, 4).map((tag) => (
                        <span
                          key={tag}
                          className="text-xs font-mono text-[#71717A] bg-[#27272A] px-2 py-0.5 rounded"
                        >
                          {tag}
                        </span>
                      ))}
