...
export const alt = 'Sage Field Notes — real incidents, mapped in public'
    ...
    (
      ...
      >
        <div style={{ display: 'flex', fontSize: 26, letterSpacing: 6, color: '#8FA0FF', textTransform: 'uppercase' }}>
          Sage Academy · Field notes
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <div style={{ display: 'flex', fontSize: 70, fontWeight: 700, letterSpacing: -2, lineHeight: 1.08, maxWidth: 1000 }}>
            Real incidents, mapped in public — free.
          </div>
          <div style={{ display: 'flex', fontSize: 30, color: '#9C9CA6' }}>Stake, map, verdict — one decision per note</div>
        </div>
