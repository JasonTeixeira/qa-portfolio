...
const PROJECTS: Project[] = [
  {
    ...
    goal: 'An AI that reviews your code — and absolutely roasts it. Live on the web.',
    ship: 'https://roast-my-code.app',
    steps: [
      {
        title: 'Send it the code',
        why: 'One API call and a frontier model is reading your code.',
        code: "const res = await ai.chat({\n  model: 'claude-opus',\n  messages: [{ role: 'user', content: code }],\n})",
        out: '…analyzing your 400-line function 👀',
      },
      {
        title: 'Make it savage',
        why: 'A system prompt sets the personality. Yours is brutal.',
        code: "system: 'You are a senior dev. Be brutally\\nhonest and very funny. No mercy.'",
        out: '“This variable is named `x`. Bold.”',
      },
      {
        title: 'Stream the burn',
        why: 'The roast appears line by line — it feels alive.',
        code: 'for await (const token of res.stream) {\n  ui.append(token)\n}',
        out: 'R · o · a · s · t · i · n · g …',
      },
      {
        title: 'Ship it',
        why: 'Deploy to a real URL. Send it. Watch friends suffer.',
        code: '$ vercel --prod\n✓ deploying…',
        out: '✓ Live. Drop the link in the group chat.',
      },
    ],
  },
  {
