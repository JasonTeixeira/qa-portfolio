...
const REPLIES: [RegExp, string][] = [
  ...
  [/pric|cost|\$|pay|precio|价格|मूल्य|tarif/i, 'One membership: $25/month or $250/year, every course as it ships — labs, proofs, recall, leagues, certificates. And a 14-day honest guarantee: no proof shipped, full refund.'],
