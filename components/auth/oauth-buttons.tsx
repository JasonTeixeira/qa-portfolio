...
export function OAuthButtons({ next = '/auth/redirect' }: { next?: string }) {
  const baseClass =
    'group flex items-center justify-center gap-2.5 w-full rounded-xl border border-white/[0.08] bg-black/40 px-4 py-2.5 text-sm font-medium text-[#FAFAFA] hover:border-white/20 hover:bg-white/[0.05] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30';
  return (
