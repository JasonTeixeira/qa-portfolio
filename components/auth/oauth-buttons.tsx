...
export function OAuthButtons({ next = '/auth/redirect' }: { next?: string }) {
  const baseClass =
    'group flex items-center justify-center gap-2.5 w-full rounded-lg border border-[#2A2826] bg-[#0B0A09] px-4 py-2.5 text-sm font-medium text-[#FAFAFA] hover:border-[#3D5AFE]/50 hover:bg-[#131316] transition-colors';
  return (
