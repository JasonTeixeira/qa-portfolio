  ...
  return (
    <div className={`flex flex-wrap gap-2 ${className}`}>
      <a
        ...
        className="inline-flex items-center gap-2 rounded-full border border-[#2A2826] bg-[#1A1917] px-3.5 py-1.5 text-xs font-mono text-[#A8A29E] hover:border-[#3D5AFE]/40 hover:text-[#FAFAFA] transition-colors"
      >
