...
export function PullQuote({ children }: { children: React.ReactNode }) {
  return (
    <blockquote className="sage-rise relative my-12 py-6 pl-8 border-l-[3px] border-[#3D5AFE]">
      <div
...
export function Callout({
  ...
  accent?: 'blue' | 'teal' | 'coral' | 'lime'
}) {
  const colors = {
    blue: 'border-[#3D5AFE]/30 bg-[#3D5AFE]/[0.04]',
    teal: 'border-[#3D5AFE]/30 bg-[#3D5AFE]/[0.04]',
