...
export default [
  ...
  ['04', "Now, your first instinct might be <THE OBVIOUS FIX>. But that doesn't work, because <WHY>. (optional beat)"],
  ['05', "So here's the fix. It's called <NAME>. Think of it like <A KID-SIMPLE EVERYDAY ANALOGY>."],
  ['06', "Let's walk through how it works. Step one: <ONE IDEA, plainly. Define any new term right here.>"],
  ['07', "Step two: <THE NEXT IDEA. Add more step beats if the topic needs them.>"],
  ['08', "Here's the part people skip: <THE CRUCIAL EXTRA STEP>. (optional beat)"],
  ['09', "Let me show you a real example. <ONE CONCRETE WALK-THROUGH, start to finish, showing it actually work.>"],
  ['10', "Now, a few common mistakes to avoid. One: <MISTAKE + FIX>. Two: <MISTAKE + FIX>. Three: <MISTAKE + FIX>."],
