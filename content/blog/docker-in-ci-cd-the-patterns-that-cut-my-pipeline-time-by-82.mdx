...
id: 18
description: 'Layer caching, multi-stage builds, BuildKit, and the Docker patterns that took my CI pipeline from 45 minutes to 8 minutes.'
cluster: cloud-infra
keywords:
  - Docker
  - CI/CD
  ...
  - patterns
  - pipeline
canonical: 'https://www.sageideas.dev/blog/docker-in-ci-cd-the-patterns-that-cut-my-pipeline-time-by-82'
---
