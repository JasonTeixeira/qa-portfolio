...
id: 37
description: 'Your .env file has your database password, Stripe secret key, and AWS credentials. It''s in a Slack message, a developer''s laptop, and probably a Docker image somewhere. Let''s fix that.'
cluster: cloud-infra
keywords:
  - Security
  - Environment Variables
  ...
  - security
  - every
canonical: 'https://www.sageideas.dev/blog/environment-variables-the-security-hole-in-every-startup'
---
