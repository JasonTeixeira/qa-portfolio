...
id: 30
description: Most developers debug by changing things until the error goes away. I debug by narrowing the blast radius systematically. Here's my actual framework.
...
keywords:
  ...
  - issues
  - framework
canonical: 'https://www.sageideas.dev/blog/how-i-debug-production-issues-a-real-framework-not-guessing'
---
