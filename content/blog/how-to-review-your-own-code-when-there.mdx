...
id: 34
description: Solo engineering means no code reviews. I've developed a self-review process that catches 80% of what a second pair of eyes would find. It starts with stepping away.
cluster: solo-studio
keywords:
  - Code Review
  - Solo Engineering
  ...
  - there
  - nobody
canonical: 'https://www.sageideas.dev/blog/how-to-review-your-own-code-when-there'
---
