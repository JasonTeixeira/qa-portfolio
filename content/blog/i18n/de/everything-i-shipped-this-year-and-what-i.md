---
title: "Alles, was ich dieses Jahr ausgeliefert habe (und was ich im Nachhinein streichen würde)"
...
# Alles, was ich dieses Jahr ausgeliefert habe (und was ich im Nachhinein streichen würde)
...
1. Trading-Dashboard (185 Tabellen, 69 APIs, Stripe-Abrechnung)
2. Discord AI Engine (30+ Befehle, GPT-4o, 12 Phasen)
3. Research Engine (71+ Metriken, Strategieanalyse)
4. Alert System (.NET 8, NinjaTrader-Integration)
5. Newsletter Studio (automatisierte Content-Pipeline)
6. Strategy Tracker (Performance-Analytik)
...
1. **Bestehende Projekte verbessern.** Die 11 öffentlichen Repos in meinem Portfolio brauchen stärkere READMEs, mehr Commits, bessere CI und echte Screenshots. Qualität vor Quantität.

2. **Eine Terraform-Modul-Bibliothek.** Wiederverwendbare AWS-Module für die Muster, die ich mehrfach gebaut habe. Das schließt die Infrastruktur-Lücke in meinem Portfolio.

3. **Open-Source-Beiträge.** Selbst kleine PRs zu etablierten Projekten verleihen Glaubwürdigkeit. Ich möchte 5–10 sinnvolle Beiträge zu Projekten leisten, die ich tatsächlich nutze (Next.js, Supabase, Playwright).
