...
id: 39
description: Dashboards with 47 panels where everything is green aren't monitoring. They're decoration. Here's what I actually monitor and why most alerting is useless noise.
cluster: cloud-infra
keywords:
  - Monitoring
  - SRE
  ...
  - actually
  - tells
canonical: 'https://www.sageideas.dev/blog/monitoring-that-actually-tells-you-something'
---
