...
id: 16
description: 'The math behind RiskRadar — Value at Risk, Conditional VaR, Ledoit-Wolf shrinkage, and Monte Carlo simulation explained for engineers who aren''t quants.'
...
keywords:
  ...
  - explained
  - covariance
canonical: 'https://www.sageideas.dev/blog/portfolio-risk-math-explained-var-cvar-and-why-covariance-estimation-matters'
---
