...
id: 33
description: 'Your API works perfectly at 10 requests per second. At 10,000, it falls over. Here''s how I implement rate limiting that protects without annoying legitimate users.'
cluster: cloud-infra
keywords:
  - Security
  - API
  ...
  - nobody
  - thinks
canonical: 'https://www.sageideas.dev/blog/rate-limiting-the-feature-nobody-thinks-about-until-it'
---
