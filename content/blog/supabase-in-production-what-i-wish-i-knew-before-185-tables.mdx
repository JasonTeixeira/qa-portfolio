...
id: 36
description: 'After a year of running Supabase in production with 185 tables, here''s the honest review — what''s incredible, what''s frustrating, and what almost made me switch.'
cluster: cloud-infra
keywords:
  - Supabase
  - PostgreSQL
  ...
  - production
  - before
canonical: 'https://www.sageideas.dev/blog/supabase-in-production-what-i-wish-i-knew-before-185-tables'
---
