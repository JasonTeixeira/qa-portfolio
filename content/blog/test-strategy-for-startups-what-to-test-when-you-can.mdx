...
id: 20
description: You have 2 engineers and 100 features. You can't test everything. Here's the risk-based test strategy I use to maximize coverage with minimal investment.
cluster: testing-qa
keywords:
  - Testing
  - QA
  ...
  - startups
  - everything
canonical: 'https://www.sageideas.dev/blog/test-strategy-for-startups-what-to-test-when-you-can'
---
