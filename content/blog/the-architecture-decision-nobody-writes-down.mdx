...
id: 32
description: We spend weeks choosing between Kafka and RabbitMQ but never document why. ADRs take 15 minutes and save months of 'why did we do this?' conversations.
...
keywords:
  ...
  - nobody
  - writes
canonical: 'https://www.sageideas.dev/blog/the-architecture-decision-nobody-writes-down'
---
