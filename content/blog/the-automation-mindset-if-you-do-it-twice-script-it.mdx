...
id: 46
description: 'I have 47 shell scripts, 6 CI workflows, and a cron job that texts me when my SSL cert is expiring. Here''s the mindset behind automating everything.'
...
keywords:
  ...
  - mindset
  - twice
canonical: 'https://www.sageideas.dev/blog/the-automation-mindset-if-you-do-it-twice-script-it'
---
