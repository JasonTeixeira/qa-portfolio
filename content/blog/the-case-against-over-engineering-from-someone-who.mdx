...
id: 35
description: I once built a plugin architecture for a system that never needed plugins. 3 weeks of abstraction layers for a feature nobody asked for. Here's how I learned to stop.
...
keywords:
  ...
  - over-engineering
  - someone
canonical: 'https://www.sageideas.dev/blog/the-case-against-over-engineering-from-someone-who'
---
