...
id: 28
description: 'ORMs are great until they''re not. After debugging generated queries that took 30 seconds on a 185-table database, I switched to raw SQL for the hot paths. Here''s when each makes sense.'
...
keywords:
  ...
  - product systems
  - instead
canonical: 'https://www.sageideas.dev/blog/why-i-use-raw-sql-instead-of-an-orm-most-of-the-time'
---
