...
All formal notices required under this Agreement must be in writing and delivered by: (a) email with read-receipt or acknowledgment; (b) overnight courier; or (c) certified mail, return receipt requested. Notices to Studio are sent to legal@sageideas.dev. Notices to Client are sent to the address specified in the SOW. Notices are effective upon delivery.
