...
Next lesson → **`functions-and-modules`** (PENDING).
...
| 2 | `error-handling` | Error handling | `deep-nodes/error-handling.md` | PENDING |
| 3 | `functions-and-modules` | Functions & modules | cluster + std CS | PENDING |
| 4 | `types-and-data` | Types | cluster + std CS | PENDING |
| 5 | `control-flow` | Data & control flow | cluster + std CS | PENDING |
...
|---|---|---|---|---|---|
| 1 | `programming-fundamentals` | engineering | `01-programming-fundamentals` | 9 clusters | **WIP (1/9)** |
