...
| Team Admin | Sage Team Admin | **CUT (operator decision 2026-07-03: no team plans)** — Sage confirmed team plans are out of scope; the academy is individual-only. Team Admin design is CUT (not built). Corollary cleanups: drop the "team seats" clauses from Legal and any team references from Cancel; these products are single-seat only. No academy_teams/seats backend to build. |
