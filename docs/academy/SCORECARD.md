...
**Tuned-surface design avg: 90.75 (dashboard 94 + leagues 93 irresistible; profile 90; review 86).**
**Full 12-category design avg: ~87.** Baseline was 76.

Next unblocked (lowest design, Stage 1): **#4 Quests/variable-reward (80)** and **#2 Onboarding first-win (80)**.
Reality-gated (await live cohort, do not fake-green): **#10, #12**, and the behavioral half of **#5, #8, #11**.
