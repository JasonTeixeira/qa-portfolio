...
export const RAG_EVAL_QUESTION_SEEDS: RagEvalQuestionSeed[] = [
  ...
  ...buildCategoryQuestions('quiz_challenge_points', [
    ...
    ['rag_points_004', 'How should challenge submissions be handled?', ['challenge', 'wins', 'points']],
    ...
    ['rag_points_008', 'What should a first project template include?', ['project', 'acceptance criteria', 'reviewed']],
